...
LABEL org.opencontainers.image.source="https://github.com/macula-services/mcl-search"
...
WORKDIR /app
COPY --from=builder /build/_build/prod/rel/mcl_search ./

ENV HOME=/app
ENV RELX_REPLACE_OS_VARS=true

ENV MCL_NODE_NAME=mcl_search
ENV MCL_NODE_HOST=127.0.0.1
ENV MCL_COOKIE=mcl_search
ENV MCL_HEALTH_PORT=8497
...
CMD ["/app/bin/mcl_search", "foreground"]
